...
void buscarLibroEspanol() {
    ...
    if(espanol)
        cout << "Hay libros en espanol\n\n";
    else
        cout << "No hay libros en espanol\n\n";
}

void buscarLibroFiccion() {
    cout << "buscando...\n";
    ...
    if(ficcion)
        cout << "Hay libros de ciencia ficcion\n\n";
    else
...
void eliminarLibroMisterio(){
    ...
    cout << "Los libros de misterio han sido eliminados" << endl;
}
...
int main(){
    ...
    do{
        ...
        switch(opcion){
            ...
            break;
            case 5: buscarLibroEspanol(); break;
            case 6: buscarLibroFiccion(); break;
            case 7: eliminarLibroMisterio(); break;
